...
import { updateCreative } from "@/actions/campaign-actions";
import { FaCloudUploadAlt, FaSpinner, FaImage, FaSave } from "react-icons/fa";
...
export default function EditCreativeForm({ campaignId, creative }: { campaignId: string, creative: CreativeData }) {
    ...
    const [previewUrl, setPreviewUrl] = useState<string | null>(creative.imageUrl);
    ...
    const action = updateCreative.bind(null, campaignId, creative.id);
