            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <div
                      className="absolute inset-0 bg-white dark:bg-gray-800 rounded-full shadow-sm border border-gray-200/50 dark:border-white/5 transition-all duration-300"
                    />
                  )}
                  ...
                  {!isActive && isHovered && (
                    <div
                      className="absolute inset-0 bg-gray-200/50 dark:bg-gray-800/50 rounded-full transition-all duration-200"
                    />
                  )}
