                ...
                {(isMobileMenuOpen || typeof window !== 'undefined' && window.innerWidth >= 768) && (
                    <>
                        ...
                        <motion.aside
                            ...
                            className={cn(
                                "fixed md:sticky top-0 left-0 z-50 h-screen w-[280px] bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 flex flex-col shadow-xl md:shadow-none",
